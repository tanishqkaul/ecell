...
const experiences = [
  ...
  {
    title: "Dragons Den",
    link: "https://forms.gle/Z86ZGdseZHdSCgtJ8",
    icon: COLLABS,
    iconBg: "#383E56",
    date: "14th Mar 2024",
    points: [
      ...
      "Market opportunity: Briefly outline the target market and its potential size.", 
      "Implementation plan: Highlight key steps for bringing your idea to life.", 
      "Financial projections (optional): Briefly illustrate your projected revenue and cost model.",
    ],
  },

  {
    title: "Digital Marketing Competition",
    link: "https://forms.gle/vLYKeTdQSeVLLBE37",
    icon: COLLABS,
    iconBg: "#383E56",
    date: "15th Mar 2024",
    points: [
      "In a team of 2 to 4",
      "Participants can analyze real-world business challenges faced by startups or established companies related to digital marketing.",
    "Identifying target audience and developing buyer personas.",
    "Crafting compelling marketing messages across various digital channels.",
    "Utilizing appropriate social media strategies and content marketing tactics.",
    "Implementing effective performance tracking and analytics.",
    ],
  },
  {
    title: "100 to Million",
    link: "https://docs.google.com/forms/d/e/1FAIpQLSf0jbH5pTb7s-bces5wxN_lM4oETCmmOXjE5WF1bAvV5xvMLg/viewform",
    icon: COLLABS,
    iconBg: "#383E56",
    date: "15th Mar 2024",
    points: [
      "Each team must consist of 4-5 members.",
    "The game is for two days.",
  ...
  {
    title: "Squid Game",
    link: "https://forms.gle/cR4ZV3tifCg1F3y27",
    icon: COLLABS,
    iconBg: "#383E56",
    date: "15th Mar 2023",
    points: [
